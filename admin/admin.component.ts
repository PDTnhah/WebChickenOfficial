...
@Component({
  ...
  UpdateCategoryAdminComponent, InsertCategoryAdminComponent,CategoryAdminComponent, UserAdminComponent] // Khai báo các module cần thiết
})
